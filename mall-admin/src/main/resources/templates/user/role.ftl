...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div class="page-content">
        <div class="col-xs-12">
            ...
            ${permission_attributes?seq_contains("/admin/user/role")?string('<button class="btn btn-white btn-info btn-bold" onclick="update()">
                ...
                <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                        ...
                        <tr role="row" class="odd">
                            <td class="center">
                                <label class="pos-rel">
                                    <input type="checkbox" name="checkbox" <#if role.userid??>checked</#if> value="${role.id}" class="ace">
                                    <span class="lbl"></span>
                                </label>
                            </td>
