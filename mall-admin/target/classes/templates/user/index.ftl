        ...
        <div class="col-xs-12">
            ...
            <div>
                <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" user="grid" aria-describedby="dynamic-table_info">
                        <thead>
                        <tr user="row">
                        ...
                        <tr user="row" class="odd">
                            ...
                            <td>${user.name}</td>
                            <td>${user.email!}</td>
                            <td class="hidden-480"><#if user.creator==0>系统初始化用户<#else>${user.creator!}</#if></td>
                        ...
                        ${permission_attributes?seq_contains("/admin/user/edit")?string('<a class="green" href="/admin/user/edit?id=${user.id}" attr="编辑用户信息">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>','')}
                        ${permission_attributes?seq_contains("/admin/user/role")?string(' <a class="green" href="/admin/user/role?id=${user.id}">
                                        <i class="ace-icon fa fa-cog bigger-130"></i>
                                    </a>','')}
                        <#--${permission_attributes?seq_contains("/admin/user/delete")?string('<a class="red" onclick="del(${user.id})">-->
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="dataTables_info" id="dynamic-table_info" user="status" aria-live="polite">第${nowBegin}-${nowEnd}条，共${count}条
                            </div>
                        </div>
