        ...
        <div class="col-xs-12"><a href="/admin/role/edit">
            ...
            <div>
                <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                    <form method="get" action="/admin/role" id="sform">
                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td>
                                ...
                                ${permission_attributes?seq_contains("/admin/role/edit")?string('<a class="green" href="/admin/role/edit?id=${role.id}">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i>
                                    </a>','')}
                                ${permission_attributes?seq_contains("/admin/role/menu")?string('<a class="green" href="/admin/role/menu?id=${role.id}">
                                        <i class="ace-icon fa fa-cog bigger-130"></i>
                                    </a>','')}
                                <#--${permission_attributes?seq_contains("/admin/role/delete")?string('<a class="red" onclick="del(${role.id})">-->
...
<script type="text/javascript">
    jQuery(function($) {
        ...
        new page({pageMain:"pagination",nowPage:${page!'1'},count:${count},pageSize:${pageSize!'10'},
            url:"/admin/role",params:"?pageSize=${pageSize}&query=${query}",pakey:"page"});
    });
    /**
     * 删除角色
     */
